...
output "gateway_subnet_arns" {
  description = "List of ARNs of gateway subnets"
  value       = aws_subnet.gateway.*.arn
}

output "gateway_subnets_cidr_blocks" {
  description = "List of cidr_blocks of gateway subnets"
  value       = aws_subnet.gateway.*.cidr_block
}

output "gateway_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of gateway subnets in an IPv6 enabled VPC"
  value       = aws_subnet.gateway.*.ipv6_cidr_block
}
...
output "pod_subnet_arns" {
  description = "List of ARNs of pod subnets"
  value       = aws_subnet.pod.*.arn
}

output "pod_subnets_cidr_blocks" {
  description = "List of cidr_blocks of pod subnets"
  value       = aws_subnet.pod.*.cidr_block
}

output "pod_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of pod subnets in an IPv6 enabled VPC"
  value       = aws_subnet.pod.*.ipv6_cidr_block
}
...
output "gateway_route_table_ids" {
  description = "List of IDs of gateway route tables"
  value       = aws_route_table.gateway.*.id
}

output "pod_route_table_ids" {
  description = "List of IDs of pod route tables"
  value       = aws_route_table.pod.*.id
}
...
output "gateway_internet_gateway_route_id" {
  description = "ID of the internet gateway route."
  value       = concat(aws_route.gateway_internet_gateway.*.id, [""])[0]
}

output "gateway_internet_gateway_ipv6_route_id" {
  description = "ID of the IPv6 internet gateway route."
  value       = concat(aws_route.gateway_internet_gateway_ipv6.*.id, [""])[0]
}

output "pod_nat_gateway_route_ids" {
  description = "List of IDs of the pod nat gateway route."
  value       = aws_route.pod_nat_gateway.*.id
}

output "pod_ipv6_egress_route_ids" {
  description = "List of IDs of the ipv6 egress route."
  value       = aws_route.pod_ipv6_egress.*.id
}
...
output "gateway_route_table_association_ids" {
  description = "List of IDs of the gateway route table association"
  value       = aws_route_table_association.gateway.*.id
}

output "pod_route_table_association_ids" {
  description = "List of IDs of the pod route table association"
  value       = aws_route_table_association.pod.*.id
}
...
output "gateway_network_acl_id" {
  description = "ID of the gateway network ACL"
  value       = concat(aws_network_acl.gateway.*.id, [""])[0]
}

output "gateway_network_acl_arn" {
  description = "ARN of the gateway network ACL"
  value       = concat(aws_network_acl.gateway.*.arn, [""])[0]
}

output "pod_network_acl_id" {
  description = "ID of the pod network ACL"
  value       = concat(aws_network_acl.pod.*.id, [""])[0]
}

output "pod_network_acl_arn" {
  description = "ARN of the pod network ACL"
  value       = concat(aws_network_acl.pod.*.arn, [""])[0]
}
